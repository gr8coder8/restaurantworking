...
<title>Online Food Delivery:About</title>
...
<div id="header">
  ...
  <div id="company_name">Online Food Delivery</div>
</div>
<div id="center">

  <h1>ABOUT Online Food Delivery</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
  <p>Online Food Delivery is a multinational restaurant food chain and delivery service with an aim of providing nutritious food to all our current and esteemed customers in Kenya and the world. This is achieved through quality services that surpases customers' satisfaction.</p>
...
<div id="footer">
  ...
  <div class="bottom_addr">&copy; 2016 - Online Food Delivery by Mohammad Sadiq</div>
</div>
</div>
